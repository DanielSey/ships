...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*imagePlay.setOnTouchListener(myTouchListener);
        imageStats.setOnTouchListener(myTouchListener);
        imageSettings.setOnTouchListener(myTouchListener);
        imageCredits.setOnTouchListener(myTouchListener);
        imageExit.setOnTouchListener(myTouchListener);*/
    }
    ...
    /*ImageView.OnTouchListener myTouchListener = new View.OnTouchListener() {
        @Override
        public boolean onTouch(View view, MotionEvent motionEvent) {
            switch (motionEvent.getAction())
            {
                ...
                {
                    ((ImageView) view).getDrawable().setColorFilter(Color.argb(120, 0, 255, 0), PorterDuff.Mode.SRC_ATOP);
